...
//     category: string;
//     industry: string;
//     time: string;  // Add time filter here
//   };
...
//       {/* Exchange Filter */}
//       <Select
//         value={filters.exchange || null}
//         onValueChange={(value) => setFilters({ ...filters, exchange: value })}
//       >
//         <SelectTrigger className="w-48">
//           <SelectValue placeholder="Filter exchange..." />
//         </SelectTrigger>
//         <SelectContent>
//           <SelectItem value={null}>All Exchanges</SelectItem>
...
//       {/* Time Filter */}
//       <Select
//         value={filters.time || "all_time"}  // Default value is "all_time"
